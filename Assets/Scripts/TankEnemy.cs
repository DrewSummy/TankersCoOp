...
public class TankEnemy : Tank
{
    ...
    private TankPlayer player1Script;           // Store a reference to our TankPlayer of player 1.
    private TankPlayer player2Script;           // Store a reference to our TankPlayer of player 2.
    ...
    protected new void Start()
    {
        ...
        projectile = Resources.Load("ShellEnemy") as GameObject;
