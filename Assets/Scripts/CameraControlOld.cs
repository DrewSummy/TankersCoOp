...
namespace Completed
{
    public class CameraControlOld : MonoBehaviour
    {
        ...
        public BackgroundWave backgroundScript;
        ...
        //TODO: move the camera instead of the transform
        ...
        private void Move()
        {
            if (battling)
            {
                ...
                background.position = Vector3.MoveTowards(transform.position, m_target - battleOffset, step);
            }
            else
            {
                ...
                background.position = Vector3.MoveTowards(transform.position, m_target - patrolOffset, step);
            }
        }
        ...
        public void PlaceOnFirstRoom(Vector2 firstRoomCoord)
        {
        ...
        {
            backgroundScript.activateMatch(true);
            battling = true;
        }
        ...
        public IEnumerator endBattleCamera()
        {
            ...
            backgroundScript.activateMatch(false);
            battling = false;
        }
